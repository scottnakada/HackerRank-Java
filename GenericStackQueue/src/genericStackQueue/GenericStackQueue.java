...
/* Create an abstract generic Stack or Queue class */
public abstract class GenericStackQueue <inputType> {
	...
	public int search(inputType searchValue) {
		/* Is the stack empty? */
		if (head == null) {
